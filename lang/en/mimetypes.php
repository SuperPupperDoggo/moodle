...
$string['application/vnd.ti.8x.program'] = 'TI-83/84 Plus Program';
$string['application/vnd.ti.8x.appvar'] = 'TI-83/84 Plus AppVar';
$string['application/vnd.ti.8x.list'] = 'TI-83/84 Plus List Data';
$string['application/vnd.ti.8x.matrix'] = 'TI-83/84 Plus Matrix Data';
$string['application/vnd.ti.8x.asm'] = 'TI-83/84 Plus Assembly Program';
$string['application/vnd.ti.83.bundle'] = 'TI-83 Bundle Image';
$string['application/vnd.ti.84pce.bundle'] = 'TI-84 Plus CE Bundle Image';
...
$string['group:ti'] = 'TI Calculator files';
