...
abstract class core_filetypes {
    ...
    protected static function get_default_types() {
        return array(
            ...
            '8xl' => array('type' => 'application/vnd.ti.8x.list', 'icon' => 'text', 'groups' => array('ti')),
            '8xm' => array('type' => 'application/vnd.ti.8x.matrix', 'icon' => 'calc', 'groups' => array('ti')),
            '8xp' => array('type' => 'application/vnd.ti.8x.program', 'icon' => 'sourcecode', 'groups' => array('ti')),
            '8xv' => array('type' => 'application/vnd.ti.8x.appvar', 'icon' => 'archive', 'groups' => array('ti')),
            '8xz' => array('type' => 'application/vnd.ti.8x.asm', 'icon' => 'sourcecode', 'groups' => array('ti')),
            ...
            'b83' => array('type' => 'application/vnd.ti.83.bundle', 'icon' => 'archive', 'groups' => array('ti')),
            'b84' => array('type' => 'application/vnd.ti.84pce.bundle', 'icon' => 'archive', 'groups' => array('ti')),
